                ...
                preview={
                    <Modal>
                        ...
                        <ModalContent>
                            ...
                            <ModalFooter>
                                <ModalClose>
                                    <button className="px-4 py-2 bg-gray-100 text-black rounded">Cancel</button>
                                </ModalClose>
                        ...
                        <ModalContent>
                            ...
                            <ModalBody>
                                <div className="flex gap-2">
                                    <input value="https://example.com/share/123" readOnly className="w-full border rounded text-black p-2" />
                                    <button className="bg-green-500 text-white px-3 rounded">Copy</button>
                                </div>
                            </ModalBody>
                            <ModalFooter>
                                <ModalClose>
                                    <button className="text-sm  px-4 py-2 bg-gray-100 text-black rounded">Close</button>
                                </ModalClose>
                            </ModalFooter>
                        </ModalContent>
                    </Modal>
