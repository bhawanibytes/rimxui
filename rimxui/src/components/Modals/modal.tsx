            ...
            {open && (
                ...
                >
                    <motion.div
                        ...
                        className={mc(
                            "relative bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 rounded-2xl shadow-lg px-4 py-6 sm:px-6 sm:py-8 w-[90%] max-w-md",
                            className
                        )}
                    ...
                    >
                        <button
                            onClick={() => setOpen(false)}
                            className="absolute top-2 right-2 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400"
                        >
                            <X size={20} />
                        </button>
                        {children}
...
export const ModalDescription = ({
    ...
    <p className={mc("text-sm text-gray-500 dark:text-gray-400", className)}>{children}</p>
)
