...
export const LISTITEM_HOVER_STYLES = {
  default: "transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-gray-800",
  primary: "transition-colors duration-200 hover:bg-blue-50 dark:hover:bg-blue-800/30",
  secondary: "transition-colors duration-200 hover:bg-purple-50 dark:hover:bg-purple-800/30",
